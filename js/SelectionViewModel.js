...
function SelectionViewModel(svgViewModel, materialViewModel, selectionGroup) {
    ...
    self.selMinSegmentLength = ko.observable("6");
    ...
    self.getAllPaths = function() {
        ...
        var unusableElements = hiddenGroup.selectAll(unusableElementNames);
        unusableElements.forEach(function(e) {
            showAlertLocalized('[html]errors.UnsupportedSvg', {thing: e.type}, 'alert-warning', false);
        });
        hiddenGroup.selectAll("rect, path").forEach(function(element) {
